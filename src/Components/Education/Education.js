    ...
    <div class="education">
      <div id="education"></div>
       ...
       <div className="academic">
                <span className = "degree">Bachelors Degree in Computer science</span>
       ...
       <div className="academic">
                ...
                <span className = "school">Microverse Remote Software Training</span>
                <span className = "period">May 2019 - January 2020 </span>
            </div>
            <div className="academic">
                <span className = "degree">Cisco Certified Network ProfessionalCCNP(CSCO12205364)</span>
                <span className = "school">CISCO Network Academy</span>
                <span className = "period">June 2010 - August 2012 </span>
            </div>
            <div className="academic">
                <span className = "degree">Diploma in Information and Communication Technology</span>
